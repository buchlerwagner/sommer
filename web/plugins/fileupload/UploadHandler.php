...
class UploadHandler extends ancestor
{
    ...
    public function __construct($options = null, $initialize = true, $error_messages = null) {
        $this->response = array();
        $this->options = array(
            'script_url' => $this->get_full_url().'/ajax/gallery/upload/',
            'upload_dir' => dirname($this->get_server_var('SCRIPT_FILENAME')).FOLDER_UPLOAD.DEFAULT_HOST.'/gallery/',
            'upload_url' => $this->get_full_url().FOLDER_UPLOAD.DEFAULT_HOST.'/gallery/',
